    ...
    where TEntity : IHasExtraProperties
{
    ...
    private void SelectedValueChanged(SelectItem<object> selectedItem)
    {
        Entity.SetProperty(PropertyInfo.Name, selectedItem, false);
        UpdateLookupTextProperty(selectedItem);
    }
